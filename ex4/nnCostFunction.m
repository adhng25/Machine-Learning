...
A2 = [ones(m, 1) sigmoid(X * Theta1')]; % A2 = 5000*26
A3 = sigmoid(A2 * Theta2'); % A3 = 5000*10

y_matrix = zeros(m, num_labels); % y_maxtrix = 5000*10
for i = 1 : m
    y_matrix(i, y(i)) = 1; 
end
...
for i = 1 : m
    ...
    a2 = [1 sigmoid(z2)]; % a2 = 1*26
    z3 = a2 * Theta2'; % z3 = 1*10
    a3 = sigmoid(z3); % a3 = 1*10
    
    delta3 = a3 - y_matrix(i,:); % 1*10
    delta2 = (delta3 * Theta2) .* sigmoidGradient([1, z2]); % 1*26
